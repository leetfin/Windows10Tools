...
title Windows10Tools - Windows10Privacy - Remove Everything
:: BatchGotAdmin
:-------------------------------------
...
taskkill /F /IM RuntimeBroker.exe
PowerShell -command "mv C:\Windows\SystemApps\Microsoft.MicrosoftEdge_8wekyb3d8bbwe C:\Windows\SystemApps\Microsoft.MicrosoftEdge_8wekyb3d8bbwe_BAK"
...
REM all done
@echo off
echo Complete. You may need to restart your computer for changes to take effect.
pause